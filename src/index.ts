...
app.get('/',async(req,res)=>{ 
  ...
  app.post('/tx_callback',async(req,res)=>{ 
    ...
    res.send(`<!DOCTYPE html><html><head>
      <title>Glo Dollar Donation Frame</title>
      <meta property="og:image" content="https://glodollar.cryptocheckout.co/share.png" />
      <meta property="fc:frame" content="vNext" />
      <meta property="fc:frame:image" content="https://glodollar.cryptocheckout.co/share.png" />
...
app.post('/get_tx_data',async function (_req: Express.Request, res: TransactionTargetResponse <{chainId: string;
